            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <span>احصائيات المدرسة</span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="<?php echo base_url("admin/cheetstatics")?>"><i class="fa fa-hand-paper-o"></i> احصائيات </a></li>
                    </ul>
                </li>
                <?php endif;?>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo base_url("admin/allschool")?>"><i class="fa fa-circle-o"></i> المدارس المسجلة </a></li>
                        <li><a href="<?php echo base_url("admin/schoolstatics")?>"><i class="fa fa-hand-paper-o"></i> احصائيات </a></li>
                    </ul>
                </li>
                <?php endif;?>
            </ul>
